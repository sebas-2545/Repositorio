...
if(isset($_GET['id'])){
    $id=$_GET['id'];
$noti="SELECT * FROM noticias Where id = '$id'";
                            ...
                            <div class="container">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form action="../assets/controller/ControllerediNoticia.php" method="post">
                                            <div class="form-group">
                                                <label for="titulo">Título</label>
                                                <input type="text"  name="id" value="<?php echo  $id  ?> "  id="mi_input" style="display: none;">

                                                <input type="text" id="titulo" name="titulo"  value="<?php  echo $re['Titulo']?>"class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="empresa">Nombre de la Empresa</label>
                                                <input type="text" id="empresa" name="empresa" value="<?php echo $re['Empresa']?>" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="correo">Correo Electrónico</label>
                                                <input type="email" id="correo" name="correo"value="<?php echo $re['Correo'] ?>" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="mensaje">Mensaje</label>
                                                <textarea id="mensaje" name="mensaje" rows="5"value="<?php echo $re['Mensaje'] ?>" class="form-control" required></textarea>
                                            </div>
