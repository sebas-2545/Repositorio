...
<body>
    ...
    <form action=" ../assets/controller/ControllerResponder.php" method="post">
...
<script>
    function irAEnlace(enlace) {
        ...
        <div class="botones">
            ...
            <div class="button" >
                <span class="button__text">Responder Magna</span>
            ...
            <div class="button" onclick="location.href='<?php echo 'magna.php' ?>'">
