...
?>
		...
		<div id="sidebar" class="sidebar responsive">
				...
				<ul class="nav nav-list">
					<li <?php if (strpos($url,'../private/admin.php') !== false) {echo 'class="active"';}?> >
						<a href="admin.php">
					...
					>
						...
						<ul class="submenu">
							<li <?php if (strpos($url,'../private/instructor.php') !== false) {echo 'class="active"';}?>><a href="instructor.php"><i class="menu-icon"></i><i class="fa fa-caret-right"></i> Panel Instructores</a>

								<b class="arrow"></b>
							</li>

							<li <?php if (strpos($url,'../private/revisar.php') !== false) {echo 'class="active"';}?>><a href="revisar.php"><i class="menu-icon"></i><i class="fa fa-caret-right"></i> Revisar Usuarios</a>

								<b class="arrow"></b>
							</li>
							<li <?php if (strpos($url,'../private/banlist.php') !== false) {echo 'class="active"';}?>><a href="banlist.php"><i class="menu-icon"></i><i class="fa fa-caret-right"></i> Manejar Baneos</a>
					...
					<li <?php if (strpos($url,'news') !== false) {echo 'class="active"';}?>>
						...
						<ul class="submenu">
							<li <?php if (strpos($url,'../private/newsadd.php') !== false) {echo 'class="active"';}?>>
								<a href="newsadd.php">
							...
							<li <?php if (strpos($url,'../private/news.php') !== false) {echo 'class="active"';} if (strpos($url,'newsedit.php') !== false) {echo 'class="active"';}?> >
								<a href="news.php">
									<i class="menu-icon"></i><i class="fa fa-caret-right"></i>
									Todas las fichas
								</a>
